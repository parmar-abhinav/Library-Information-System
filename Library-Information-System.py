...
def fun(e):
    ...
    def student():
        ...
        dept=Entry(root)
        dept.place(x=350,y=400)
        Label(root,text="sex",font='Times New Roman',fg='green',width=10,height=2).place(x=70,y=190)
        g=IntVar()
        Radiobutton(root,text='Male',variable=g,value=1).place(x=350,y=200)
        Radiobutton(root,text='Female',variable=g,value=2).place(x=350,y=250)
